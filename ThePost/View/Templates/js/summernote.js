...
(function (factory) {
  ...
  var defaults = {
    ...
    options: {
      ...
      iconPrefix: 'glyphicon glyphicon-',         // prefix for css icon classes
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      picture: function (lang, options) {
        return tplIconButton(options.iconPrefix + 'picture', {
      ...
      table: function (lang, options) {
        var dropdown = '<ul class="note-table dropdown-menu">' +
                       ...
                       '</ul>';
        return tplIconButton(options.iconPrefix + 'th', {
      ...
      style: function (lang, options) {
        ...
        return tplIconButton(options.iconPrefix + 'text-size', {
      ...
      underline: function (lang, options) {
        return tplIconButton(options.iconPrefix + 'text-color', {
          event: 'underline',
      ...
      ul: function (lang, options) {
        return tplIconButton(options.iconPrefix + 'list', {
          event: 'insertUnorderedList',
          title: lang.lists.unordered
        });
      },
      ol: function (lang, options) {
        return tplIconButton(options.iconPrefix + 'sort-by-order', {
      ...
      paragraph: function (lang, options) {
        ...
        var outdentButton = tplIconButton(options.iconPrefix + 'backward', {
          title: lang.paragraph.outdent,
          event: 'outdent'
        });
        var indentButton = tplIconButton(options.iconPrefix + 'forward', {
      ...
      help: function (lang, options) {
        return tplIconButton(options.iconPrefix + 'question-sign', {
      ...
      fullscreen: function (lang, options) {
        return tplIconButton(options.iconPrefix + 'fullscreen', {
          event: 'fullscreen',
          title: lang.options.fullscreen
        });
      },
      codeview: function (lang, options) {
        return tplIconButton(options.iconPrefix + 'console', {
          event: 'codeview',
    ...
    var tplPopovers = function (lang, options) {
      ...
      var tplImagePopover = function () {
        ...
        var circleButton = tplIconButton(options.iconPrefix + 'adjust', {
        ...
        var noneButton = tplIconButton(options.iconPrefix + 'stop', {
          title: lang.image.shapeNone,
          event: 'imageShape',
          value: ''
        });

        var removeButton = tplIconButton(options.iconPrefix + 'remove', {
